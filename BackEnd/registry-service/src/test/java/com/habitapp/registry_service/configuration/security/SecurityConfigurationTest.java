...
public class SecurityConfigurationTest {
    ...
    void setUp() {
        ...
        when(credential.username()).thenReturn("testUser");
        when(credential.password()).thenReturn("testPassword");
    }
    ...
    void testInMemoryUserDetailsManagerBean() {
        UserDetails user = inMemoryUserDetailsManager.loadUserByUsername("testUser");
