package com.habitapp.motivation_service.common.utlil.generator.random.token;

import java.security.SecureRandom;

import com.habitapp.motivation_service.annotation.Util;
import com.habitapp.motivation_service.common.utlil.cryptography.hash.HashUtil;
...
public class RandomTokenGeneratorUtil {
    ...
    /**
     * generate a random token that contains 64 characters. it generates a
     * random 64 bytes then hash this random 64 bytes with SHA256 it returns an
     * arrays of 512 bytes then convert this 512 bytes to a string of
